...
final class MovieDetailsViewController: UIViewController {
    ...
    private var movieID: Int? // To keep the selected movie id, so we can fetch similars
    ...
    private func showMovieDetails(_ movieDetails: MovieDetails) {
        ...
        let displayViewController = MovieDetailsDisplayViewController(movieID: movieID,
